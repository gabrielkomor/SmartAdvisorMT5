...
class BottomFrameBuilder:
    ...
    def bottom_frame_setup(self):
        ...
        self.label_additive_decision.setPixmap(QtGui.QPixmap("images\\holdIcon.png"))
        ...
        self.label_majority_decision.setPixmap(QtGui.QPixmap("images\\holdIcon.png"))
        ...
        self.label_median_decision.setPixmap(QtGui.QPixmap("images\\holdIcon.png"))
