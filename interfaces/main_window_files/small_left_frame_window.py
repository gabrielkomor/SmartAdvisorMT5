...
class SmallLeftFrameBuilder:
    ...
    def small_left_frame_setup(self):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(
            QtGui.QPixmap("images\\menuIcon.png"),
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(
            QtGui.QPixmap("images\\downloadIcon.png"),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(
            QtGui.QPixmap("images\\candleStickIcon.png"),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(
            QtGui.QPixmap("images\\historyDecisionIcon.png"),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(
            QtGui.QPixmap("images\\histPlotIcon.png"),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(
            QtGui.QPixmap("images\\linearPlotIcon.png"),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(
            QtGui.QPixmap("images\\shopIcon.png"),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(
            QtGui.QPixmap("images\\exitIcon.png"),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
