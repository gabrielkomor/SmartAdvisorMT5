...
class RightFrameBuilder:
    ...
    def right_frame_builder_setup(self):
        ...
        self.label_sma_decision.setPixmap(QtGui.QPixmap("images\\holdIcon.png"))
        ...
        self.label_rsi_decision.setPixmap(QtGui.QPixmap("images\\holdIcon.png"))
        ...
        self.label_bb_decision.setPixmap(QtGui.QPixmap("images\\holdIcon.png"))
        ...
        self.label_macd_decision.setPixmap(QtGui.QPixmap("images\\holdIcon.png"))
        ...
        # self.label_mma = QtWidgets.QLabel(parent=self.right_frame)
        # font = QtGui.QFont()
        # font.setFamily("Maiandra GD")
        # font.setPointSize(10)
        # font.setBold(True)
        # font.setWeight(75)
        # self.label_mma.setFont(font)
        # self.label_mma.setStyleSheet("color: white;")
        # self.label_mma.setObjectName("labelMMA")
        # self.vertical_layout_3.addWidget(self.label_mma, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        # self.label_mma_decision = QtWidgets.QLabel(parent=self.right_frame)
        # self.label_mma_decision.setMinimumSize(QtCore.QSize(45, 45))
        # self.label_mma_decision.setMaximumSize(QtCore.QSize(60, 60))
        # self.label_mma_decision.setText("")
        # self.label_mma_decision.setPixmap(QtGui.QPixmap("images\\holdIcon.png"))
        # self.label_mma_decision.setScaledContents(True)
        # self.label_mma_decision.setObjectName("labelMmaDecision")
        # self.vertical_layout_3.addWidget(self.label_mma_decision, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.label_adx_decision.setPixmap(QtGui.QPixmap("images\\holdIcon.png"))
        ...
        self.label_volume_decision.setPixmap(QtGui.QPixmap("images\\holdIcon.png"))
